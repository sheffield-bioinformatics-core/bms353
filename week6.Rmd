...
Upon downloading your data, you should create a new RStudio project inside the same directory.

*File* -> *New Project*

then create a new Markdown file to document your analysis

*File* -> *New File* -> *R markdown*

Use the Knit drop-down menu to create a *Word* document from your analysis. It is advisable to do this often rather than waiting until you have completed your analysis.

The submitted document should contain only text and figures. When creating the Word you will need to set `echo=FALSE, warning=FALSE, message=FALSE` in all the *chunk options*.

See the file [workflow_overview.Rmd](workflow_overview.Rmd) for an example.
