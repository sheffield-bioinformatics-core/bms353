...
- Make a venn diagram for genes with adjusted p-value less than 0.05 in the basal and luminal subsets. How many genes overlap?
- How many differentially expressed genes are found with adjusted p-value less than 0.05 in the *multi-factor* analysis? How does this compare to the number of genes in the venn diagram?
